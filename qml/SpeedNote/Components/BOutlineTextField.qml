...
T.TextField
{
  ...
  property int virtualTopPadding: _control.title != "" ? Qaterial.Style.textField.topPaddingTitle - 10 : Qaterial.Style.textField.topPadding
  //topPadding: _control.title != "" ? Qaterial.Style.textField.topPaddingTitle - 10 : Qaterial.Style.textField.topPadding
  //bottomPadding: anyHintVisible ? Qaterial.Style.textField.bottomPaddingHint + 5 : Qaterial.Style.textField.bottomPadding
  ...
  Qaterial.Label
  {
    ...
    y: titleUp ? Qaterial.Style.textField.topPaddingTitleOffset - 10 : _control.virtualTopPadding + 3
  ...
  background: Rectangle
  {
    ...
    border.color:  errorState ? Qaterial.Style.errorColor : _control.activeFocus ? Qaterial.Style.accentColor : parent.borderColor //_control.activeFocus ? errorState ? Qaterial.Style.errorColor : Qaterial.Style.accentColor : parent.borderColor
    border.width: _control.activeFocus ? 2 : 1
    radius: 6
    height: (_control.helperText != "" || _control._errorText != "") ? parent.height : parent.height
  }
  Qaterial.Label // Hint
  {
